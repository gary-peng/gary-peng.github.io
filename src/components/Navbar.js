...
export default function Navibar() {
    ...
    return (
        <div class="sidenav d-none d-md-flex flex-column justify-content-between align-items-center h-100 py-3">
            <img class="mx-auto" src={logo} width="30" height="auto" loading="lazy" />
